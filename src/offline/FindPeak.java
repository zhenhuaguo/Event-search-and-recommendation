...
public class FindPeak {
	...
	private static List<LocalTime> initBuckets() {
		...
		for (int i = 0; i < 96; ++i) {//24 hours have 96 15-minutes
			buckets.add(time); 
		...
		return buckets;
              ...
              // “00:12” 在"00:00"-"00:15"用"00:00"表示
	...
	public static void main(String [] args) {
		...
		// emit(this.time.substring(0, 5), 1); MAP to SHUFFLING is called EMIT
		// }
		// }
		...
		results.forEach(new Block<Document>() {
			...
			public void apply(final Document document) {
				String time = findBucket(document.getString("_id"));//15 minutes
